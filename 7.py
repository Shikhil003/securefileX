...
class SecureFileXGUI(QWidget):
    ...
    def initUI(self):
        ...
        self.open_file_button = QPushButton("Open Selected File", self)
    ...
    def open_selected_file(self):
        if self.selected_file_path and os.path.exists(self.selected_file_path):
            ...
            QMessageBox.warning(self, "No File Selected", "No file selected or file does not exist.")
    ...
    def encrypt_file(self):
        ...
        if not key:
            QMessageBox.warning(self, "No Key", "Please enter or generate a key first.")
            return
        ...
        try:
            ...
            QMessageBox.information(self, "Encryption", f"File encrypted successfully!\nSaved as:\n{encrypted_file_path}")
    ...
    def decrypt_file(self):
        ...
        if file_path:
            ...
            try:
                ...
                QMessageBox.information(self, "Decryption", f"File decrypted successfully!\nSaved as:\n{decrypted_file_path}")
